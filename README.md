...
If custom training is disabled, models will come from MMLAB's model zoo.Else, you can also choose to load a model you trained yourself with our plugin train_mmlab_text_detection. In this case make sure you give to the plugina config file (.py) and a model file (.pth). Both of these files are produced by the train plugin.
